...
\data{The classroom materials, simulation files, worksheets, manuscript sources, and supporting documentation are available through the project GitHub repository and archived on Zenodo \cite{garg2026repository}.}

\suppdata{No separate supplementary data files are submitted with this manuscript. Supporting materials are available through the GitHub repository and Zenodo archive cited in the data availability statement.}
...
Garg A 2026 \textit{mranuraggarg/teacher-guided-ai-virtual-physics-labs: Version 1.0.1 -- Zenodo archive release} GitHub repository archived on Zenodo doi:10.5281/zenodo.20425377
